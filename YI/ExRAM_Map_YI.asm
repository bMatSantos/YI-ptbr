...
!EXRAM_YI_Player_FacingDirectionLo = $0000C6|!SRAMBankBaseAddress
!EXRAM_YI_Player_FacingDirectionHi = !EXRAM_YI_Player_FacingDirectionLo+$01
!EXRAM_YI_Player_CurrentSwimStateLo = $0000C8|!SRAMBankBaseAddress
...
!EXRAM_YI_Player_CurrentEggThrowStateLo = $0000EC|!SRAMBankBaseAddress
!EXRAM_YI_Player_CurrentEggThrowStateHi = !EXRAM_YI_Player_CurrentEggThrowStateLo+$01
